...
class UniversalVariables {
  ...
  static final Color themeOrange = Color(0xffd2691e);
  static final Color separatorColor = Color(0xff272c35);

  static final Color gradientColorStart = Color(0xffffb74d);
  static final Color gradientColorEnd = Color(0xffef6c00);

  static final Color senderColor = Color(0xffd2691e);
  static final Color receiverColor = Color(0xff2b343b);
