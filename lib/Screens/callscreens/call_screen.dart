...
import 'package:tria/configs/agora_configs.dart';
        ...
        children: <Widget>[
          RawMaterialButton(
            ...
            child: Icon(
              ...
              color: muted ? Colors.white : UniversalVariables.themeOrange,
              size: 20.0,
            ),
            shape: CircleBorder(),
            elevation: 2.0,
            fillColor: muted ? UniversalVariables.themeOrange : Colors.white,
